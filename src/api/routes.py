...
async def list_products(
    ...
    roast_level: Optional[str] = Query(None, description="Filter by roast level ('light', 'medium', 'medium_dark', 'dark')"),
    process_method: Optional[str] = Query(None, description="Filter by process method ('washed', 'natural', 'anaerobic', etc.)"),
    estate_name: Optional[str] = Query(None, description="Filter by origin estate name"),
    q: Optional[str] = Query(None, description="Search query by name, sku, estate, or description"),
